...
where starting_point= '$city1'";
          ...
          if(stts>=5 && stts<10){
                   ...
                   echo "<td ><span style='background-color:rgb(255, 255, 117); color:#3f3f3f;font-weight: bold;  border-radius: 5px; width:5rem; padding: 1rem;'>".$row['status']." seats available</span> </td>";
            ...
            echo'     </div>';
                ...
                if(stts<5){
                   ...
                   echo "<td ><span style='color:#3f3f3f;font-weight: bold; background-color:rgb(255, 50, 94); border-radius: 5px; width:5rem; padding: 1rem;'>".$row['status']." seats available</span> </td>";
